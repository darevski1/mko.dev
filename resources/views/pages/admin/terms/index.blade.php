...
@section('title', '| Услови за користење')
            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <form method="POST" action="{{ action('TermsController@update', ['id' => $term->id]) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  name="description" rows="20" id="summernote"  class="form-control">{{$term ->description}}</textarea>
                                </div>
                                <div class="form-group">
